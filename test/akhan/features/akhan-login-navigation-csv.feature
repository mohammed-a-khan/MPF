...
Feature: AKHAN Login and Navigation - CSV Data Driven
  ...
  @DataProvider(source="test/akhan/data/akhan-login-data.csv",type="csv",headers="true",delimiter=",",parseBooleans="false",filter="environment=SIT,status=Active")
  Scenario: AKHAN Login Verification with CSV Data
  ...
  @DataProvider(source="test/akhan/data/akhan-navigation-data.csv",type="csv",headers="true",delimiter=",",parseBooleans="false",filter="testType=navigation,executeFlag=Y")
  Scenario: Navigate to AKHAN modules using CSV Data
  ...
  @DataProvider(source="test/akhan/data/akhan-menu-items.csv",type="csv",headers="true",delimiter=",",parseBooleans="false",filter="menuGroup=main")
  Scenario: Verify menu structure using CSV Data
    Given I am logged in to AKHAN application
